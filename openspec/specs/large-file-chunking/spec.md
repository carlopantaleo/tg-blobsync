# Large File Chunking Specification

## Purpose

Defines how files exceeding the configured chunk threshold are transparently split into ordered document messages, enabling support for logical files larger than the single-file Telegram limits, while maintaining legacy fallbacks and updating the topic index.
